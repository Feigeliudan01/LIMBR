...
for i in range(1, 21):
    #Read Raw Data
    to_impute = imputation.imputable('twenty_miss_5_NN_'+str(i)+'_with_noise.txt',missingness=0.2,neighbors=5)
...
for i in range(1, 21):
    #Read Raw Data
    to_impute = imputation.imputable('twenty_miss_10_NN_'+str(i)+'_with_noise.txt',missingness=0.2,neighbors=10)
    #Impute and Write Output
...
for i in range(1, 21):
    #Read Raw Data
    to_impute = imputation.imputable('twenty_miss_15_NN_'+str(i)+'_with_noise.txt',missingness=0.2,neighbors=15)
    #Impute and Write Output
...
for i in range(1, 21):
    #Read Raw Data
    to_impute = imputation.imputable('thirty_miss_5_NN_'+str(i)+'_with_noise.txt',missingness=0.3,neighbors=5)
    #Impute and Write Output
...
for i in range(1, 21):
    #Read Raw Data
    to_impute = imputation.imputable('thirty_miss_10_NN_'+str(i)+'_with_noise.txt',missingness=0.3,neighbors=10)
    #Impute and Write Output
...
for i in range(1, 21):
    #Read Raw Data
    to_impute = imputation.imputable('thirty_miss_15_NN_'+str(i)+'_with_noise.txt',missingness=0.3,neighbors=15)
    #Impute and Write Output
...
for i in range(1, 21):
    #Read Raw Data
    to_impute = imputation.imputable('forty_miss_5_NN_'+str(i)+'_with_noise.txt',missingness=0.4,neighbors=5)
    #Impute and Write Output
...
for i in range(1, 21):
    #Read Raw Data
    to_impute = imputation.imputable('forty_miss_10_NN_'+str(i)+'_with_noise.txt',missingness=0.4,neighbors=10)
    #Impute and Write Output
...
for i in range(1, 21):
    #Read Raw Data
    to_impute = imputation.imputable('forty_miss_15_NN_'+str(i)+'_with_noise.txt',missingness=0.4,neighbors=15)
    #Impute and Write Output
